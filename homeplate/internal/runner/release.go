// Package runner implements Engine A: Homeplate's wrapper around GitHub's
// official actions/runner agent.
//
// Homeplate does not reimplement the runner protocol. It downloads the official
...
// guess. Homeplate always passes --disableupdate so the agent cannot silently
...
// v2.335.1 is the last known-good release on this platform. Homeplate pins it
...
// Cache manages downloaded runner tarballs under ~/.homeplate/runner.
